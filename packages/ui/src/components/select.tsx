...
/**
 * Select do shadcn, ajustado à identidade do Integra Edu.
 *
 * Substitui o `<select>` nativo em todo o app: o nativo herda a caixa do
 * sistema operacional, que ignora raio, tipografia e altura de toque — a
 * mesma tela ficava diferente no Windows, no macOS e no Android.
 *
 * O gatilho tem 44px de altura, raio de 14px e fundo `muted`, como os demais
 * campos. O popup é o único lugar do app onde existe sombra, porque é overlay
 * real (`--ie-shadow-overlay`).
 */
    ...
    <SelectPrimitive.Portal>
      ...
      >
        <SelectPrimitive.Popup
          ...
          className={cn(
            "data-[side=bottom]:slide-in-from-top-2 data-[side=inline-end]:slide-in-from-left-2 data-[side=inline-start]:slide-in-from-right-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-open:fade-in-0 data-open:zoom-in-95 data-closed:fade-out-0 data-closed:zoom-out-95 relative isolate z-50 max-h-(--available-height) w-(--anchor-width) min-w-36 origin-(--transform-origin) overflow-y-auto overflow-x-hidden rounded-control bg-popover p-1 text-popover-foreground shadow-[var(--ie-shadow-overlay)] ring-1 ring-border duration-100 data-[align-trigger=true]:animate-none data-closed:animate-out data-open:animate-in",
            className,
          )}
          {...props}
        >
